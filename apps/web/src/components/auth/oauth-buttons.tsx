...
const OAuthButton = ({ provider }: { provider: OAuthProvider }) => {
  ...
  return (
    <a
      ...
      className={cn(
        'border-input inline-flex w-full items-center justify-center gap-2 rounded-md border',
        'bg-background text-foreground px-4 py-2 text-sm font-medium',
...
const Divider = () => (
  <div className="relative">
    ...
    <div className="relative flex justify-center">
      <span className="bg-background text-muted-foreground px-2 text-xs uppercase tracking-wide">
        or
      </span>
    </div>
  </div>
...
const GoogleLogo = () => (
  <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden>
    ...
    <path
      fill="#EA4335"
      d="M12 5.38c1.62 0 3.07.56 4.21 1.64l3.16-3.15C17.45 2.09 14.97 1 12 1A11 11 0 0 0 2.18 7.07l3.66 2.84C6.71 7.31 9.14 5.38 12 5.38Z"
    />
  </svg>
);
